...
<div class="login-overlay" id="loginOverlay">
  <div class="login-card">
    ...
    <p id="recoveryHint" style="display:none;font-size:12px;color:var(--text-secondary);margin-top:8px;background:var(--bg);padding:12px 14px;border-radius:6px;text-align:left;line-height:1.7">忘记密码后，使用<strong>RESET_KEY</strong>作为密码登录，密码将重置为 <strong>admin</strong>。<br><br>· 本地/Docker：查看 <code>config/config.json</code> 的 <code>resetKey</code> 字段<br>· Cloudflare：查看 Dashboard → Variables 中的 <code>RESET_KEY</code></p>
  </div>
</div>

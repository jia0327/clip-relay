...
var Room = class {
  ...
  async scheduleAlarm(token) {
    ...
    const delay = Math.max(expires - Date.now(), 1e3);
    try {
...
async function handleLogin(request, env) {
  ...
  const hint = limit.remaining <= 1 ? "\uFF0C\u5FD8\u8BB0\u5BC6\u7801\u8BF7\u91CD\u7F6E" : "";
...
// .wrangler/tmp/bundle-4HF4OB/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-4HF4OB/middleware-loader.entry.ts

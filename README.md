...
> 🚀 **在线演示**：[relay.itellme.icu](https://relay.itellme.icu/?token=test-wge734dpyax7) — 打开即用，无需注册
...
- 三种发送方式：Ctrl+V 粘贴 / 点 🖼 按钮选择 / 拖放图片到页面
- 消息列表显示缩略图，点击放大查看
...
> **忘记密码**：查看 `config.json` 中的 `adminPassword` 字段，或修改后重启服务。
